...
namespace AdditionalCorehelper.Logging.NLogRealization
{
    public class LoggingService : NLog.Logger, ILoggingService
    {
        ...
        {
            this.Debug(exception, string.Empty, null);
        }

        public void Error(Exception exception)
        {
            this.Error(exception, string.Empty, null);
        }

        public void Fatal(Exception exception)
        {
            this.Fatal(exception, string.Empty, null);
        }

        public void Info(Exception exception)
        {
            this.Info(exception, string.Empty, null);
        }

        public void Trace(Exception exception)
        {
            this.Trace(exception, string.Empty, null);
        }

        public void Warn(Exception exception)
        {
            this.Warn(exception, string.Empty, null);
        }
